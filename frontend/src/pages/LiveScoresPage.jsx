                ...
                <table className="table games-table" id={`games-table-${sport}`}>
                  ...
                  <tbody>
                    {grouped[sport].map((g) => {
                      ...
                      return (
                        <tr key={g.game_id} className="game-row" style={{ cursor: 'pointer' }} onClick={() => navigate(`/games/${g.game_id}/details`)}>
                          <td>{g.sport}</td>
                          <td>
                                ...
                                {g.home_logo && (
                                  <img
                                    ...
                                    onError={e => {
                                      ...
                                      e.target.src = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"><rect width="100%" height="100%" fill="%23ccc"/><text x="50%" y="50%" font-size="10" text-anchor="middle" fill="%23666" dy=".3em">?</text></svg>';
                                    }}
                                  />
                                )}
                                {g.home_team}
    ...
    <>
      ...
      {error && (
        <div className="error-message" role="alert">
          <span>{error}</span>
          <button onClick={clearError} className="error-dismiss">Dismiss</button>
        </div>
      )}
      <h1>Live Scores</h1>
      ...
      {loading && <p role="status" aria-live="polite">Loading live games…</p>}

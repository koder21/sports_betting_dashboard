...
function SportsAnalyticsPage() {
  ...
  const { data: sportData, loading } = useApi(fetchSportData, null);
      ...
      {loading ? (
        <div className="loading-container">
          ...
          <div className="loading-text">
            Loading {activeSport === 'ALL' ? 'all sports' : activeSport} analytics...
          </div>
        </div>
      ) : sportData ? (
        activeSport === 'ALL' ? (
            ...
            <div className="sport-kpi-grid">
              <div className="sport-kpi-card games">
                ...
                <div className="sport-kpi-value">
                  {sportData.total_games?.toLocaleString() || 0}
                </div>
                <div className="sport-kpi-label">Total Games Tracked</div>
                <div className="sport-kpi-sublabel">Across all sports leagues</div>
              </div>
              ...
              <div className="sport-kpi-card players">
                ...
                <div className="sport-kpi-value">
                  {sportData.total_players?.toLocaleString() || 0}
                </div>
                <div className="sport-kpi-label">Total Players</div>
                <div className="sport-kpi-sublabel">All leagues combined</div>
              </div>
              ...
              <div className="sport-kpi-card stats">
                ...
                <div className="sport-kpi-value">
                  {sportData.sports_comparison
                    ?.reduce((sum, s) => sum + (s.recent_games_30d || 0), 0)
                    ?.toLocaleString() || 0}
                </div>
                <div className="sport-kpi-label">Recent Games (30d)</div>
                <div className="sport-kpi-sublabel">Active across all sports</div>
              </div>
              ...
              <div className="sport-kpi-card teams">
                ...
                <div className="sport-kpi-value">
                  {sportData.sports_comparison
                    ?.reduce((sum, s) => sum + (s.total_teams || 0), 0)
                    ?.toLocaleString() || 0}
                </div>
                <div className="sport-kpi-label">Total Teams</div>
                <div className="sport-kpi-sublabel">All leagues roster</div>
              </div>
            </div>
            ...
            <div className="charts-grid">
              ...
              <div className="chart-card">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <RadarChart
                    data={
                      sportData.sports_comparison?.map((s) => ({
                        sport: s.sport,
          ...
          <>
            <div className="sport-kpi-grid">
              ...
              <div className="sport-kpi-card players">
                ...
                <div className="sport-kpi-sublabel">
                  Avg {Math.round((sportData.total_players || 0) / (sportData.total_teams || 1))}{' '}
                  per team
                </div>
              </div>
              ...
              <div className="sport-kpi-card stats">
                <div className="kpi-header">
                  <div className="sport-kpi-icon">📊</div>
                  <div className="kpi-metric">{sportData.avg_total_score?.toFixed(1) || 0} PPG</div>
                </div>
                <div className="sport-kpi-value">
                  {sportData.total_stats?.toLocaleString() || 0}
                </div>
              ...
              <div className="sport-kpi-card teams">
                ...
                <div className="sport-kpi-value">
                  {sportData.total_teams?.toLocaleString() || 0}
                </div>
                <div className="sport-kpi-label">Active Teams</div>
                <div className="sport-kpi-sublabel">{activeSport} league roster</div>
              </div>
            </div>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <RadarChart
                    data={[
                      ...
                      {
                        metric: 'Home Wins',
                        value: (sportData.home_wins || 0) / 10,
                        fullMark: 100,
                      },
                      {
                        metric: 'Away Wins',
                        value: (sportData.away_wins || 0) / 10,
                        fullMark: 100,
                      },
                    ]}
                  >

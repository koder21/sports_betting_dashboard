...
Type: spread, Selection: Lakers -5.5, Game: Lakers vs Suns, Date: 2026-02-08, Game ID: 789, Odds: -110, Stake: 100, Reason: Home advantage.`}
      ...
      <div className="input-helper-text">
        <strong>Tip:</strong> Click "Copy for AI" to get fresh game data, then paste it into an AI chat to get betting recommendations. 
        Paste the AI's recommendations here and click "Place Bets".
      </div>
    </div>
  );
});

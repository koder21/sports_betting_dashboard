#!/usr/bin/env python3
"""
Manually link bets to placeholder game records since ESPN games aren't available
"""
import sqlite3
...
# Get all pending bets (regardless of date)
cursor.execute("""
...
# Manual game mapping - create game_ids for your bets
game_ids = {
